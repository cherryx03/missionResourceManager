...
public class Calculator {
    ...
    // GUIHandler calls getCrewBasedSupplyLevels, which in turn calls getTotalDailyConsumption.
    // getTotalDailyConsumption checks which resource is being requested and calls the corresponding getDaily____Consumption function
    // which will return the rate at which those resources are consumed
    // then, getSupplyLevels is called to do the monster math (the monster math)
